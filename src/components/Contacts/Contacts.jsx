...
const Contacts = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_upsy4fo', 'template_3eokh2h', form.current, 'SC_bnHUKFpbiEh2BS')
      e.target.reset()
  };
  ...
  return (
    <section id="contact">
       ...
       <article className="contact__option">
        ...
        <h4>Messenger</h4>
        <h5>Ifeanyi Osuji</h5>
        <a href="https://m.me/ifeanyi.osuji.733" target="_blank" rel="noreferrer">Send me a message </a>
       </article>
       <article className="contact__option">
